...
<xsl:stylesheet version="2.0"
  ...
  <!-- This XSLT adds the Solr query parameters passed in the
       ...
       A facet.field element may have various attributes reflecting
       the options available for facets, used to override the default
       value for facet fields as a whole (such as the value given in
       the facet.sort element).
