...
<xsl:stylesheet xmlns:tb="https://papygreek.hum.helsinki.fi/py/"
  ...
  <xsl:template name="pg_form_mismatch">
    <xsl:variable name="count-grammatical" select="count(../sentences/sentence//word[@ending-mismatch='true'])"/>
    <xsl:variable name="count-orthographical" select="count(../sentences/sentence//word[@ending-mismatch='true'])"/>
